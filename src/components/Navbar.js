...
class Navbar extends React.Component {
  ...
  setLogo() {
    this.props.navTransparent
      ? this.setState({ logo: logoKnockout, transparent: true })
      : this.setState({ logo: logoDefault, transparent: false })
  }
  ...
  render() {
    return (
      <nav
        ref={this.navbarRef}
        className={`navbar ${this.state.transparent === true ? 'transparent' : ''} ${
          this.state.transparent === false ? 'white' : ''
        }`}
      >
        <Link to="/" className="site-logo">
          <img
            src={this.state.logo}
            alt="Marshall Goldsmith 100 Coaches"
            className="logo"
          />
        </Link>
        ...
        <div className="navbar-list">
          ...
          <div className="navbar-item">
            <a href="https://agency.100coaches.com/">Find a Coach</a>
