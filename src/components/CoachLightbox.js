      ...
      >
        ...
        <div className="flex-row">
          <div className="coach-links">
            {coach.links &&
              <>
                { coach.links.website && <a className="website icon" href={coach.links.website} title="Website" target="_blank" rel="noopener noreferrer" ><span className="hidden">{coach.links.website}</span></a> }
